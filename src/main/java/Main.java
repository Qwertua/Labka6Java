...
public class Main {
    public static void main(String[] args){
        ...
        List<Vegetables> result = range.findVegetablesByCaloriesRange(salad, 50, 75);
        ...
        List<Vegetables> res = price.sortByPrice(salad,100);
        ...
        System.out.println(calories.calculateCaloriesInSalad(salad));
